...
class GCN(nn.Module):
    def __init__(self, in_features, edge_features, out_feature, device, ratio=(4, 2)):
    ...
    def label2edge(self, targets):
        ''' convert node labels to affinity mask for backprop multilabel classification'''
...
class NodeNet(nn.Module):
    def __init__(self, in_features, num_features, device, ratio=(4, 2)):
